...
void PS2_CS_H()
{
	GPIO_SetBits(GPIOB,PS2_CS_SEL);
}

void PS2_CS_L()
{
	GPIO_ResetBits(GPIOB,PS2_CS_SEL);
}
...
void PS2_DO_H()
{
	GPIO_SetBits(GPIOB,PS2_DO_CMD);
}

void PS2_DO_L()
{
	GPIO_ResetBits(GPIOB,PS2_DO_CMD);
}

uint8_t PS2_DI()
{
	uint8_t di = GPIO_ReadInputDataBit(GPIOB, PS2_DI_DAT);
	return di;
}
